                ...
                <div class="col-md-4" style="margin-bottom: 10px; margin-top: 10px;">
                    <div class="card" style="height: auto;">
                        <div class="card-body"><img class="card-img-top scale-on-hover" src="assets/img/{{ $vP->productImage }}" alt="Card Image">
                            ...
                            <h6 class="text-muted card-subtitle mb-2" style="font-size: 23px;margin-top: 10px;margin-bottom: 10px;">{{ $vP->productPrice }}<br></h6>
                            @guest
                                @if(Route::has('register'))
                            <button class="btn btn-primary" type="button" style="margin-left: 0px;margin-right: 0px;background: #04bc00;border-style: none;margin-top: 0px;margin-bottom: 5px;" onclick="/productDetails.html">
                                <a href="/login" style="color: #f4f4f4;">Product Detail<br></a>
                            </button>
                                @endif
                            @else
                            <button class="btn btn-primary" type="button" style="margin-left: 0px;margin-right: 0px;background: #04bc00;border-style: none;margin-top: 0px;margin-bottom: 5px;" onclick="/productDetails.html">
                                <a href="/productDetails" style="color: #f4f4f4;">Product Detail<br></a>
                            </button>
                            @endguest
                        </div>
                    </div>

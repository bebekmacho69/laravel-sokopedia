                ...
                <div class="col-md-4" style="margin-bottom: 10px; margin-top: 10px;" >
                    <div class="card" style="height: 100%;">
                        ...
                        @guest
                            ...
                            <button class="btn btn-primary" type="button" style="margin-left: 6%;margin-right: 50%;margin-top: 0px;margin-bottom: 6%;">
                                <a href="/login" style="color: #f4f4f4;">Product Detail<br></a>
                            </button>
                                @endif
                            @else
                                <a class="btn btn-primary" type="button" style="margin-left: 6%;margin-right: 50%;margin-top: 0px;margin-bottom: 6%;" href="/productDetails/get/{{ $vP->productID }}">Product Detail<br></a>
                            @endguest
                    </div>
                </div>
            @endforeach

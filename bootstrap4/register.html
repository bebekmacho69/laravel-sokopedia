                        ...
                        <div class="card align-items-center" style="height: 355px;width: 416px;">
                            <div class="card-body">
                                <div class="col">
                                    ...
                                    <h6 class="text-muted mb-2" style="font-size: 23px;margin-top: 10px;margin-bottom: 10px;">Repeat Password<br><input type="password"></h6><button class="btn btn-primary" type="button" style="background: #04bc00;">Register</button></div>
                            </div>
                        </div>
                    </div>
                </div>
